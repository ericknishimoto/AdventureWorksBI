...
GO
PRINT N'Dropping Foreign Key [dbo].[FK_FactInternetSales_DimCustomer]...';
...
GO
PRINT N'Dropping Foreign Key [dbo].[FK_FactInternetSales_DimDate]...';
...
GO
PRINT N'Dropping Foreign Key [dbo].[FK_FactInternetSales_DimProduct]...';
...
GO
PRINT N'Dropping Foreign Key [dbo].[FK_FactInternetSales_DimSalesTerritory]...';
...
GO
PRINT N'Dropping Foreign Key [dbo].[FK_FactInternetSales_DimSpecialOffer]...';


GO
ALTER TABLE [dbo].[FactInternetSales] DROP CONSTRAINT [FK_FactInternetSales_DimSpecialOffer];
